export default {
    'langs': {
        'en-US': {
            ...
            'index#program#post@alert_imageDontFound': 'We couldn\'t find any image  :-(',
            'index#program#post@alert_videoDontFound': 'We couldn\'t find any video  :-(',
        ...
        'de-DE': {
            ...
            'index#program#post@alert_imageDontFound': 'Wir konnten leider kein Bild finden :-(',
            'index#program#post@alert_videoDontFound': 'Wir konnten leider kein Video finden :-(',
        ...
        'pt-BR': {
            ...
            'index#program#post@alert_imageDontFound': 'Infelizmente não conseguimos encontrar uma foto :-(',
            'index#program#post@alert_videoDontFound': 'Infelizmente não conseguimos encontrar um vídeo :-(',
