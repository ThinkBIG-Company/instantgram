...
export class Modal {
  ...
  public constructor(modalOptions?: ModalOptions) {
    ...
    this.contentStyle = modalOptions?.contentStyle || '';
  ...
  private createModal(): HTMLDivElement {
    ...
    if (this.contentStyle.length > 0) {
      modalBody.setAttribute('style', this.contentStyle);
    }
